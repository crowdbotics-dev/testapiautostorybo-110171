...
## Project Structure
    ...
    ├── testapiautostorybo_110171  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_110171`
...
2. Clone this repo and `cd testapiautostorybo_110171`
